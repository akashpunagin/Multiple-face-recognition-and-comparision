...
FACES_DIR = "multiple_faces/train"
FACES_TO_TEST_DIR = "multiple_faces/test"
...
def recognize():
    ...
    for index, loc in enumerate(img_face_loc):
        ...
        cv2.putText(img,f'Face-{index+1}',(loc[3],loc[0]),cv2.FONT_HERSHEY_PLAIN,3,(0,0,255),2)
    for index, loc in enumerate(img_test_face_loc):
        ...
        cv2.putText(img_test,f'Face-{index+1}',(loc[3],loc[0]),cv2.FONT_HERSHEY_PLAIN,3,(0,0,255),2)
